...
bool OptionsModel::GetRayTraceEnabled()
{
	return gModel->GetRendererSettings().rayTraceEnabled;
}

int OptionsModel::GetRayTraceResolution()
{
	return gModel->GetRendererSettings().rayTraceResolution;
}

int OptionsModel::GetRayTraceCircleRadius()
{
	return gModel->GetRendererSettings().rayTraceCircleRadius;
}

void OptionsModel::SetRayTraceEnabled(bool state)
{
	gModel->GetRendererSettings().rayTraceEnabled = state;
	notifySettingsChanged();
}

void OptionsModel::SetRayTraceResolution(int resolution)
{
	gModel->GetRendererSettings().rayTraceResolution = resolution;
	notifySettingsChanged();
}

void OptionsModel::SetRayTraceCircleRadius(int radius)
{
	gModel->GetRendererSettings().rayTraceCircleRadius = radius;
	notifySettingsChanged();
}
