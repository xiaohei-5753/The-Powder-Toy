...
void OptionsController::SetRayTraceEnabled(bool state)
{
	model->SetRayTraceEnabled(state);
}

void OptionsController::SetRayTraceResolution(int resolution)
{
	model->SetRayTraceResolution(resolution);
}

void OptionsController::SetRayTraceCircleRadius(int radius)
{
